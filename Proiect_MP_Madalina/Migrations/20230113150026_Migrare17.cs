...
{
    public partial class Migrare17 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sceneta_categorie = table.Column<string>(maxLength: 300, nullable: false),
                    Sceneta_varsta = table.Column<int>(nullable: false),
                    AutorID = table.Column<int>(nullable: false),
                    TeatruID = table.Column<int>(nullable: false),
                    Sceneta_data = table.Column<DateTime>(nullable: false),
                    Sceneta_pret = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
